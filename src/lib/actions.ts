...
// Helper functions
export function getMindsetTitle(
  mindsets: Mindset[],
  mindsetId: string,
): string {
...
export function getMethodsForMindset(
  methods: Method[],
  mindsetId: string,
): Method[] {
...
export function getSuccessLogsForMethod(
  logs: SuccessLog[],
  methodId: string,
): SuccessLog[] {
...
export function sortByNewest<T extends { createdAt: Date | string }>(
  items: T[],
): T[] {
  return [...items].sort(
